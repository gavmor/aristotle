...
title: "Shame (Aidos)"
category: concepts
tags: [aristotle, ethics, virtue, feeling, youth, emotion, moral-psychology]
aliases: [shame, aidos, sense of shame]
sources:
  - "Nicomachean Ethics - Aristotle.txt"
created: 2026-07-20T00:00:00Z
updated: 2026-07-20T00:00:00Z
summary: Shame (aidos) is not a virtue but a feeling—a fear of bad reputation. It is fitting for the young to restrain them, but not for the mature decent person who does no base acts.
lifecycle: draft
tier: supporting
relationships:
  - target: "[[concepts/hexis]]"
    type: related_to
  - target: "[[concepts/feeling]]"
    type: related_to
---

# Shame (Aidos)

In Book IV, Chapter 9 of Aristotle's *Nicomachean Ethics*, shame (often translated from the Greek *aidōs*) is explicitly categorized as a **feeling** rather than a **virtue** (or active condition). 

## Key Ideas

- **Not a Virtue:** Aristotle defines a sense of shame as "a certain kind of fear of a bad reputation." Because it is an involuntary bodily reaction (causing one to blush, just as fear of death causes one to turn pale), it belongs to the category of feelings, not chosen character states (virtues).
- **Appropriate Only for the Young:** Shame is praised in youth because young people "live by feeling" and are prone to error; shame serves as a necessary restraint on their passions. 
