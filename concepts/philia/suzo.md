---
title: "Living Together (Suzō / Suzēn)"
category: concepts/philia
tags: [aristotle, ethics, philia, suzo, suzen, energeia, living-together]
aliases: [suzo, suzen, living together, sharing a life, suzēn, syzēn]
sources:
  - "Nicomachean Ethics - Aristotle.txt"
created: 2026-07-23T00:00:00Z
updated: 2026-07-23T00:00:00Z
summary: Book VIII, ch. 5's account of suzēn (living together / sharing a life) as the active being-at-work (energeia) of friendship, distinguishing operational friendship from the underlying active condition (hexis).
tier: core
relationships:
...
# Living Together (Suzō / Suzēn)

In Books VIII and IX of the *Nicomachean Ethics*, Aristotle identifies **living together** (*suzēn* / *suzō*, from *syn-* "together" + *zēn* "to live") as the defining **being-at-work** (*energeia*) of friendship (*philia*).
...
### Bk. VIII, ch. 5 (Bekker 1157b5–10)

```ngloss
\ex ὥσπερ δʼ ἐπὶ τῶν ἀρετῶν οἳ μὲν καθʼ ἕξιν οἳ δὲ κατʼ ἐνέργειαν ἀγαθοὶ λέγονται, οὕτω καὶ ἐπὶ τῆς φιλίας· οἱ μὲν γὰρ συζῶντες χαίρουσιν ἀλλήλοις καὶ πορίζουσι τἀγαθά, οἱ δὲ καθεύδοντες ἢ κεχωρισμένοι τοῖς τόποις οὐκ ἐνεργοῦσι μέν, οὕτω δʼ ἔχουσιν ὥστʼ ἐνεργεῖν φιλικῶς·
\gl ὥσπερ [hōsper] [just-as]
    δʼ [d'] [however]
    ἐπὶ [epi] [concerning]
    τῶν [tōn] [the.GEN.FEM.PL]
    ἀρετῶν [aretōn] [virtues.GEN.FEM.PL]
    οἳ [hoi] [some.NOM.MASC.PL]
    μὲν [men] [on-the-one-hand]
    καθʼ [kath'] [according-to]
    ἕξιν [hexin] [active-condition.ACC.FEM.SG]
    οἳ [hoi] [others.NOM.MASC.PL]
    δὲ [de] [on-the-other-hand]
    κατʼ [kat'] [according-to]
    ἐνέργειαν [energeian] [being-at-work.ACC.FEM.SG]
    ἀγαθοὶ [agathoi] [good.NOM.MASC.PL]
    λέγονται, [legontai,] [are-called,]
    οὕτω [houtō] [so]
    καὶ [kai] [also]
    ἐπὶ [epi] [concerning]
    τῆς [tēs] [the.GEN.FEM.SG]
    φιλίας· [philias;] [friendship.GEN.FEM.SG;]
    οἱ [hoi] [those.NOM.MASC.PL]
    μὲν [men] [on-the-one-hand]
    γὰρ [gar] [for]
    συζῶντες [syzōntes] [living-together.PTCP.NOM.MASC.PL]
    χαίρουσιν [chairousin] [delight]
    ἀλλήλοις [allēlois] [in-one-another.DAT.MASC.PL]
    καὶ [kai] [and]
    πορίζουσι [porizousi] [provide]
    τἀγαθά, [tagatha,] [the-good-things.ACC.NEUT.PL,]
    οἱ [hoi] [those.NOM.MASC.PL]
    δὲ [de] [on-the-other-hand]
    καθεύδοντες [katheudontes] [sleeping.PTCP.NOM.MASC.PL]
    ἢ [ē] [or]
    κεχωρισμένοι [kechōrismenoi] [having-been-separated.PTCP.NOM.MASC.PL]
    τοῖς [tois] [by-the.DAT.MASC.PL]
    τόποις [topois] [places.DAT.MASC.PL]
    οὐκ [ouk] [not]
    ἐνεργοῦσι [energousi] [are-being-at-work]
    μέν, [men,] [indeed,]
    οὕτω [houtō] [so]
    δʼ [d'] [however]
    ἔχουσιν [echousin] [are-disposed]
    ὥστʼ [hōst'] [so-as]
    ἐνεργεῖν [energein] [to-be-at-work.INF]
    φιλικῶς· [philikōs;] [friendly-wise;]
\ft Just as concerning the virtues, however, some [people] are called good according to an active condition and others according to being-at-work, so too concerning friendship: for those living together delight in one another and provide good things, while those sleeping or separated by distance are not being-at-work, indeed, but are so disposed as to be at work in a friendly way.
```
![[1157b5.mp3]]
...
- [[concepts/philia/complete-friendship]] — complete friendship, which finds its fulfillment in suzēn
- [[concepts/energeia]] — being-at-work, the ontological category to which suzēn belongs
- [[concepts/hexis]] — active condition, the dormant state of friendship during separation
